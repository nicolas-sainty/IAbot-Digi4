...
;
const supabaseUrl = ("TURBOPACK compile-time value", "https://yrxqjugdrbwknsdcucyl.supabase.co");
const supabaseAnonKey = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InlyeHFqdWdkcmJ3a25zZGN1Y3lsIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MzgyNzUyMzIsImV4cCI6MjA1Mzg1MTIzMn0.OVGK4bzrFzZJDzN6fP8YXTAjvInLQ_qtqpz0EYAzLo4");
...
"[project]/lib/queries.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/lib/supabase.js [app-route] (ecmascript)");
;
async function getChats() {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('chat').select('*');
    if (error) throw error;
    return data;
}
async function createChat(title) {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('chat').insert({
        title: title,
...
async function getMessages(chatId) {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('message').select('*').eq('chat_id', chatId);
    if (error) throw error;
    return data;
}
}}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$queries$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/lib/queries.ts [app-route] (ecmascript)");
...
async function POST(req) {
    ...
    const chats = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$queries$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createChat"])("Chat 1");
    console.log(chats);
    console.log(result);
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__c294f6._.js.map